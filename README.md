...
## 💻 Tech Stack
- [WXT Framework](https://wxt.dev/) (Next-gen framework for Web Extensions)
- Vanilla JS (Content scripts to keep DOM footprint minimal)
- React 18 + Tailwind CSS (Popup UI)
- [pdfjs-dist](https://github.com/mozilla/pdf.js) & [mammoth.js](https://github.com/mwilliamson/mammoth.js) (Local document parsing)
